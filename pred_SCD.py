...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--pred_batch_size', required=False, default=1, help=8)
        parser.add_argument('--test_dir', required=False, default=r'test path', help='directory to test images')
        parser.add_argument('--pred_dir', required=False, default=r'prediction path', help='directory to output masks')
        parser.add_argument('--chkpt_path', required=False, default=r'training model path')
